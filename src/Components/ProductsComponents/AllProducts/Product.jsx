...
const Product = ({ product }) => {
  ...
  return (
    <div className="card bg-white relative transition-transform cursor-pointer hover:shadow-lg border pt-7 lg:pt-0 border-gray-200 rounded-2xl overflow-hidden">
      ...
      {/* Entire card clickable except Add button */}
      ...
      <div className="flex items-center justify-between px-3 sm:px-4 pb-3">
        ...
        <button
          ...
          className="flex items-center justify-center gap-1 text-green-600 bg-green-100 hover:bg-green-600 hover:text-white transition-all duration-300 py-1 px-3 sm:px-4 rounded-md text-xs sm:text-sm"
        >
          <FaCartShopping /> Add
        </button>
      </div>
